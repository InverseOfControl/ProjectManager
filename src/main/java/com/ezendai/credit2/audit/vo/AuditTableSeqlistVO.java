...
public class AuditTableSeqlistVO extends BaseVO{
    /**
	 * 
	 */
	private static final long serialVersionUID = 6850019957111184051L;
	...
	public String getAuditTableList() {
		return auditTableList;
	}

	public void setAuditTableList(String auditTableList) {
		this.auditTableList = auditTableList;
	}
}