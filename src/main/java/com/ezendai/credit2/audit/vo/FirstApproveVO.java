 ...
 */
public class FirstApproveVO extends BaseVO {
	...
	private Date auditDateStartEdu;
	@DateTimeFormat(pattern="yyyy-MM-dd") 
	private Date auditDateEndEdu;
	
	
	public Date getAuditDateStartEdu() {
		return auditDateStartEdu;
	}

	public void setAuditDateStartEdu(Date auditDateStartEdu) {
		this.auditDateStartEdu = auditDateStartEdu;
	}

	public Date getAuditDateEndEdu() {
		return auditDateEndEdu;
	}

	public void setAuditDateEndEdu(Date auditDateEndEdu) {
		this.auditDateEndEdu = auditDateEndEdu;
	}
