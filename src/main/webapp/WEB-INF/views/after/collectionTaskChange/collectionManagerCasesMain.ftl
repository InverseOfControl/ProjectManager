...
<script type="text/javascript" charset="UTF-8" src="resources/js/after/collectionTaskChange/managerCases.js"></script>
	...
	<div id="toolbar" style="height:120px;padding-top:8px;">
		<div  style="padding:8px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">
            ...
            <select  id="loanType" name="loanType"  editable="false" class="easyui-combobox" data-options="width:80">   </select>
     		<span>催收人员：</span>
            <select  id="operatorId"  name="operatorId"  editable="false" class="easyui-combobox" data-options="width:120"> 
            </select>
     		 
     		
     		<span>逾期起始日：</span><input  id="overdueStart" name="overdueStart" style="width: 180px" class="Wdate easyui-validatebox"  type="text"  onfocus="WdatePicker()"></input>
      						  - 
      			  				<input  id="overdueEnd"  name="overdueEnd" style="width: 180px" class="Wdate easyui-validatebox"  type="text"  onfocus="WdatePicker()"/>
        	<span>	&nbsp;&nbsp;&nbsp;&nbsp;营业部：</span>
            <select  id="salesDeptId" name="salesDeptId" editable="false" class="easyui-combobox" data-options="width:80"> 
          ...
          <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">			
	        <a href="javascript:void(0)" id="searchBt" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a> 
	       	    ...
	       	    <#if (flag=="1")>  	 <a href="javascript:void(0)" id="excelBt" class="easyui-linkbutton" data-options="iconCls:'icon-save'">案件导出</a>  </#if>
				    <select  id="collectionUser" name="collectionUser" editable="false" class="easyui-combobox" data-options="width:140"> </select>
            	    <a href="javascript:void(0)" id="dispatchBt" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">作业变更</a> 
            	   <#if (flag=="1")>  <a href="javascript:void(0)" id="impBt" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">导入</a>  </#if>
            	  
		</div>	
	</div>
	<form>
	
		 <div id="excelDlg" style="top: 20px;height:600px;width:900px;"></div>   
<script>	
           $(function(){
