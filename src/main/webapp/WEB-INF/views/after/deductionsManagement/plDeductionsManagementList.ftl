...
<script type="text/javascript" charset="UTF-8" src="resources/js/after/deductionsManagement/plDeductionsManagement.js"></script>
<style type="text/css">
.datagrid-toolbar {
	height: 56px;
}
       ...
       <span>报盘类型：</span>
        ...
        <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">
			<a href="javascript:void(0)" id="searchBt" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a> 
			 <#if ifEditCarLoan> 
			<a href="javascript:void(0)" id="plImmediateBt" class="easyui-linkbutton" data-options="iconCls:'icon-save'">生成划扣记录</a> 
			</#if>
			<!-- 批量划扣 -->
			<span id="plSendOffer">
			<a href="javascript:void(0)" id="plSendOfferBt" class="easyui-linkbutton" data-options="iconCls:'icon-save'">批量划扣</a> 
			</span>
			<!-- 划扣取消 -->
			<span id="plCannelOffer">
			<a href="javascript:void(0)" id="plCannelOfferBt" class="easyui-linkbutton" data-options="iconCls:'icon-save'">划扣取消</a>
			</span> 
		<!-- 	<span id="export">
