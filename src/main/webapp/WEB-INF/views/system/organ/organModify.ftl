...
<script type="text/javascript" src="resources/js/My97DatePicker/WdatePicker.js"></script>
    <form id="organModifyForm" name="organModifyForm" method="post" style="padding: 5px;">
    <input id="organId" name="organId" type="hidden"/>  
		    ...
		    <tr>
		     ...
		     <tr>
		        ...
		        <td>
		        	<span class="pre_span"><font color="red">*</font></span>
		        	<label>签约日期： </label> 
		        	<!-- <input id="signedDate" name="signedDate" class="Wdate easyui-validatebox" required="true"  type="text"  onfocus="WdatePicker()"/>-->
		...
		<div id="organBankTableDiv" style="text-align:left">
	      &nbsp;<label>银行卡信息：</label> 
	      <a id="bankCardModify" name="bankCardModify"  class="easyui-linkbutton" iconCls="icon-add" >添加银行卡</a>
		      <table width="100%" cellpadding="5" id="bankAccountTable" class="chedai" cellspacing="10" style="text-align:left; display:block"></table>
	    </div>
	    <!--memo -->
	      ...
	      <table width="100%" cellpadding="5"  class="chedai" cellspacing="10" style="text-align:left">
	        <tr>
	         <td>
		        ...
		        <a  class="easyui-linkbutton" iconCls="icon-add" id="salesDepartmentModify">添加</a>        
	         </td>
	        </tr>
	       </table>
	   ...
	   <div id="salesManagerTableDiv" width="100%" cellpadding="5" cellspacing="10" class="chedai" style="display:block">
	      <table width="45%" cellpadding="5" id="salesManagerTable" class="chedai" cellspacing="10" style="text-align:left">
		    ...
		    <td>
		        ...
		        <a  class="easyui-linkbutton" iconCls="icon-add" id="salesManagerModify">增加客户经理</a>
		    </td>
	        </tr>
	      </table>
	     </div>
	    <div id="organEdit-buttons" style="text-align:center;"  > 
	        <a class="easyui-linkbutton" id="organModifyCancel" iconCls="icon-cancel" plain="true" >撤销</a>
	        <a class="easyui-linkbutton" id="organModifySave" iconCls="icon-ok" plain="true">保存</a>
	    </div>
    </form>
<script>
            $(function(){
