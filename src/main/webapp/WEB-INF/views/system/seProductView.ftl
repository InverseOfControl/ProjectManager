...
var enumJson='${gridEnumJson}';
    ...
    <form id="seProductViewForm" name="seProductViewForm" method="post" style="padding: 5px;">
	    ...
	    <tr>
	        <td> 
        	 ...
        	 <label>借款类型 </label>  <!--hard code -->
        	  &nbsp;<label style="font-weight:bold">:</label> 
        	 <label id="productType">小企业贷</label>
	        </td>
	        <td>
	        	<span class="pre_span"><font color="red">*</font></span>
	        	<label>产品名称 </label> 
    ...
    <div id="addCarlg-buttons" style="text-align:center;"  > 
        <a class="easyui-linkbutton" iconCls="icon-ok" plain="true"  onclick="seProductClose()" >关闭</a>
    </div>
    </div>
<script>
            $(function(){
