...
<script type="text/javascript" charset="UTF-8" src="resources/js/master/comprehensiveSearch/accountCardMainList.js"></script>
...
<body>
   ...
   <input type="hidden" id="extenId"  value="${extenId}"  />	
   </span>
	<script>
           $(function(){
