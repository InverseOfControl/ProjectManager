...
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/fristApprove/firstApproveMain.js"></script>
	...
	<div data-options="region:'center'" style="overflow:hidden;height:120px; ">
		<div class="easyui-layout" data-options="fit:true">
          ...
          <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">			
	        ...
	        <a href="javascript:void(0)" id="acceptAudit" class="easyui-linkbutton"  ><span id='acceptAuditSpan'></span> </a>  
		</div>	
			<!--审核员工作量-->
<!--	<div class="easyui-panel" style="padding:5px;margin-top:10px;">
		...
		<div id="p" align="center" class="easyui-panel" title="" style="margin-top:10px;" data-options="iconCls:'icon-save',collapsible:false,minimizable:true,maximizable:true,closable:true">
			...
			<div id="centerTabs" class="easyui-tabs" data-options="region:'center',border:false,tools:'#tab-tools'">
				<div title="审核列表">	<iframe id="iframe1" src="FirstApprove/FirstApproveData/toApproveTab" frameborder="0" style="border:0;width:100%;height:100%;"></iframe></div>
				<div title="挂起列表"><iframe id="iframe2" src="FirstApprove/FirstApproveData/toHangTab" frameborder="0" style="border:0;width:100%;height:100%;"></iframe></div>
