...
<script type="text/javascript">var enumJson='${gridEnumJson}';
</script>
</head>
<body>
	<table id="bankAccountPageTb" toolbar="#toolbar"></table>
	...
	<!-- 更改银行卡对话框 -->
	<div id="changeBankAccountDlg" class="easyui-dialog" closed="true"></div>
</body>
</html>