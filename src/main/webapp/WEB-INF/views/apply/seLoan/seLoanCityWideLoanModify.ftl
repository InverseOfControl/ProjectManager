           ...
           <table cellpadding="5" id="addTable1"   cellspacing="10" style="text-align:left">
                ...
                <tr id="cityWideSeloanOwn" >
                    ...
                    <td>
                        <span class="pre_span"><font color="red">*</font></span>
                        <label> 个人负债余额</label>
                        <input id="personDebtBalance" name="personDebtBalance" class="easyui-validatebox" maxlength="15"  validType="integerCheck"  style="width:90px;"/>
                        <span>元</span>
...
<script>
            $(function(){
                $('table tr td:nth-child(odd)').css("background","#f1f5f9");
                 ...
                 $('#submitEditBtn').bind('click',submitCityWideLoanEdit);
