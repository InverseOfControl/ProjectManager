...
<div    style="text-align:right;" >
    <!-- <script type="text/javascript" charset="UTF-8" src="resources/js/apply/seLoan/wsLoanApply.js"/> -->

    <script type="text/javascript" charset="UTF-8"  >
       $('#addSeLoanForm').seLoanApply();
        $('table tr td:nth-child(odd)').css("background","#f1f5f9");        

        $('#submitEditBtnNew').bind('click',submitLoan);
        ...
        <table cellpadding="5" id="addTableNew1"   cellspacing="10" style="text-align:left">
            ...
            <tr>
                <td>
                    ...
                    <label>申请金额</label>
                    <input id="requestMoney" class="easyui-numberbox" name="requestMoney" min="50000" max="300000"  maxlength="7" validType='requestMoneyCheckW' required="true"  style="width: 90px" />
                    <span>元</span>
                </td>
                <td>
                    <span class="pre_span"><font color="red">*</font></span>
