 ...
 <form id="editLoanForm" method="post" style="padding: 5px;">
           <table cellpadding="5" id="addTable1"   cellspacing="10" style="text-align:left">
                <tr>
                    ...
                    <td ><font id="amountLimit"  style="color: blue">申请金额限制将根据您选择的会员类型做出变化</font> </td>
                 </tr>
                 <tr>
                    <td>
                         <span class="pre_span"><font color="red">*</font></span>
                         <label>申请金额</label>
                         <input id="requestMoney" class="easyui-numberbox" name="requestMoney" min="5" max="300000"  maxlength="7" validType='requestMoneyCheckW' required="true"  style="width: 90px" />
                         <span>元</span>
                    </td>
                    <td>
                        <span class="pre_span"><font color="red">*</font></span>
                ...
                <tr class="bottomLineTr">
                    ...
                    <td colspan="2">
                        ...
                        <span class="pre_span"><font color="red">*</font></span>
                        <label> 月营业额</label>
                        <input  id="monthTurnOver" name="monthTurnOver" maxlength="10" required="true"  validType="integerCheck" class="easyui-validatebox"  /><label>
                        <span>万元/月</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span class="pre_span"><font color="red">*</font></span>
                        <label>  申请人占股</label>
                        <input id="ratioOfInvestments" name="ratioOfInvestments" class="easyui-numberbox" maxlength="3" min="0" max="100"  required="true"  validType="integerCheck"   style="width:90px;"/><span>%</span>
                    ...
                    <td>
                        ...
                        <span class="pre_span"><font color="red">*</font></span>
                        <label>月净利润</label>
                        <input id="monthOfProfit" name="monthOfProfit" class="easyui-validatebox" maxlength="15"  required="true" validType="integerCheck"  style="width:90px;"/><span>万元</span>
                    </td>
                </tr>
               <tr id=""  >
                <td>
                    <span class="pre_span"><font color="red">*</font></span>
                    <label> 所属平台</label>
                    <input  id="platform" name="platform"  maxlength="15" class="easyui-validatebox" required="true" />
                </td>
                <td>
                    <span class="pre_span"><font color="red">*</font></span>
                    <label> 注册时间</label>
                    <input  id="regDate" name="regDate"  editable="false"  required="true"   class="easyui-datebox" />
                ...
                <#list 0..3 as i>
                    ...
                    <tr>
                        ...
                        <td><font color="red"> </font>
                            ...
                            <select id="relationship${i}"   name=contacterList[${i}].relationship  class="easyui-combobox conRelationship"    style="width:145px;">
                                <option value=""></option>
...
<script>
            ...
            $(function(){
                ...
                $('table tr td:nth-child(odd)').css("background","#f1f5f9");
                 ...
                 $('#submitEditBtn').bind('click',submitMultiGuaEdit);
