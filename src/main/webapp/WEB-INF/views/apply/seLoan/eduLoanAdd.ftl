...
<div    style="text-align:right;" >
    ...
    <script type="text/javascript" charset="UTF-8"  >
       $('#addSeLoanForm').seLoanApply();
        ...
        $('#submitEditBtnNew').bind('click',submitEduLoan);
        $('#closeLoanBtn').bind('click',closeLoanAdd);
        $('#addSeLoanForm').eduLoanApply();
        ...
        <table cellpadding="5" id="addTableNew1"   cellspacing="10" style="text-align:left">
            ...
            <tr>
                <td >
                    ...
                    <input id="organID"  name="organID" class="easyui-combobox" editable="false"  required="true"  data-options="width:200"/>
                </td>
                 <td >
                 ...
                 <td >
                    ...
                    <input id="schemeID"  name="schemeID" class="easyui-combobox"  editable="false"  required="true" style="width:300"/>
            ...
            <tr>
                <td>
                    <label> 与谁同住</label>
                     ...
                     <label> 共</label>
                      <input id=" " name="livingWithNum"    style="width: 30px"/>
                     <label> 人</label>
            ...
            <tr>
                <td >
                    ...
                    <input  id="entranceDate" name="entranceDate"  required="true" editable="false"   class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'2000-1',maxDate:'2050-12'})" />
                </td>
                <td style="width:220px;">
                    ...
                    <input  id=" " name=" "    class="easyui-numberbox zxIncomeSource" valueEle="salaryIncomeType" style="width:60px;" />元／月


                    <input  id="rentIncomeType" name="rentIncome"  type="checkbox"   />房屋出租                  
                    <input  id=" " name=" "   class="easyui-numberbox zxIncomeSource" valueEle="rentIncomeType" style="width:60px;"  />元／月

                      <input  id="otherIncomeType" name="otherIncomeAmount"   type="checkbox" />其他                 
                    <input  id=" " name=" "  class="easyui-numberbox zxIncomeSource"  valueEle="otherIncomeType"style="width:60px;"  />元 / 月
            ...
            <tr>
                   <td >
                    ...
                    <input name="historyLoanChannel" type="radio" value="银行" /><label> 银行  </label>
                    <input name="historyLoanChannel" type="radio" value="个人" /><label> 个人  </label>
                    <input name="historyLoanChannel" type="radio" value="金融机构" /><label>  金融机构 </label>
                    <input name="historyLoanChannel" type="radio" value="其他" /><label> 其他  </label>
              <!--      
        ...
        <table id="addTableNew3" class="addTable" style="display: none;">
            ...
            <tr>
                <td>
                    <span class="pre_span"><font color="red">&nbsp;</font></span>
                    <label> 营业网点</label>
                    <input id="salesDeptId" name="salesDeptId" class="easyui-combobox"    required="true"  editable="false" style="width:145px"/>
                ...
                <td>
                    ...
                    <input  id="managerName" name="managerName" editable="false"    required="true"  style="width:145px;" class="easyui-combobox" />
                </td>
