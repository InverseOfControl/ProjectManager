...
<script type="text/javascript" charset="UTF-8" src="resources/js/report/bankAccount.js"></script>
...
<body>
	<table id="bankAccount" toolbar="#toolbar"></table>
	<div id="toolbar" style="height:92px;padding-top:8px;">
        ...
        <span>ID：</span><input  id="id"  maxlength="25"  style="width: 150px" class="easyui-validatebox"/>      
        </div>
         <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">
	        <a class="easyui-linkbutton" onclick='searchBankAccount()' id="searchBtn">查询</a>
		 </div>
	</div>
 </body>
</html>