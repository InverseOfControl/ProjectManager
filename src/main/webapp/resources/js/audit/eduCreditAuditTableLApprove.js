	...
	$('#customerBut').click(function(){
		...
		$.ajax({	        
		        ...
		        success:function(loanDetailsVo){
	              	...
	              	var url = appname+'audit/eduLoan/toEditCustomerInfo';
					$('#seLoanModify').dialog({
						title: '编辑客户信息',
						closed: false,  
						cache: false,
						...
						onLoad : function(){
              					 // $('#editLoanForm').commonApplyDataModule(loanDetailsVo);
	   								...
	   								loadLoanDate(loanDetailsVo);
	   								  $('#editLoanForm').find('#salesDeptName').val(loanDetailsVo.service.name);
					...
					for(var i=0;i<list.length;i++){
						if(result.auditTableList[i].type=='0'){
							...
							"<tr id='trFP"+seqToP2+"'><td class='tdblue'><label id='seqNameP"+seqToP2+"'>对私贷流水"+seqToP2+"</label></td>";
								...
								html =html+"<td><input  validType='moneyCheck'  id='idP"+seqToP2+"' type='hidden' value='"+result.auditTableList[i].id+"'/><a href='javascript:void(0)' class='easyui-linkbutton' onclick='remarkDel(0,this)'>删除</a></td>"+
								"</tr>"+
								"<tr id='trSP"+seqToP2+"'>"+
							...
							"<tr id='trFC"+seqToC2+"'><td class='tdblue'><label id='seqNameC"+seqToC2+"'>对公贷流水"+seqToC2+"</label></td>";
								...
								html =html+"<td><input  validType='moneyCheck'  id='idC"+seqToC2+"' type='hidden' value='"+result.auditTableList[i].id+"'/><a href='javascript:void(1)' class='easyui-linkbutton' onclick='remarkDel(1,this)'>删除</a></td>"+
								"</tr>"+
								"<tr id='trSC"+seqToC2+"'>"+
