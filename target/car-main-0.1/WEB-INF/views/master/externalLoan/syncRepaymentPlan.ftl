...
<script type="text/javascript" charset="UTF-8" src="resources/js/master/syncLoan/syncRepaymentPlan.js"></script>
...
<body>
 	<table id="syncRepaymentPlanTb" toolbar="#toolbar"></table>
