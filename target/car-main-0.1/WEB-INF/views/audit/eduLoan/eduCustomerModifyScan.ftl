...
<div    style="text-align:right;" >
	...
	$('#editLoanForm').find('input').attr("disabled","disabled");
	$('#editLoanForm').find('textarea').attr("disabled","disabled");
    $('#editLoanForm .easyui-combobox').combobox({disabled:true});
        ...
        <table cellpadding="5" id="addTable1"   cellspacing="10" style="text-align:left">
            ...
            <tr>
                ...
                <td>
                    <span class="pre_span"><font color="red">*</font></span>
                    <label> 手机号码</label>
                    <input id="personMobilePhone" name="personMobilePhone"    maxlength="11" class="easyui-validatebox" required="true" />
                    
                </td>
                <td>
                    <span class="pre_span"><font color="red">&nbsp;</font></span>
                    <label> 住宅电话</label>
                    <input id="personHomePhone" name="personHomePhone" class="easyui-validatebox" maxlength="20"  style="width: 125px" placeholder="021-88888888"/>
            ...
            <tr >
                ...
                <td>
                    ...
                    <span class="pre_span"><font color="red"> </font></span>
                    <label> 固话及分机</label>
                    <input  id="phone" name="phone" class="easyui-validatebox"    maxlength="20" style="width: 118px"/>
                </td>
                <td>
       ...
       <#list 0..3 as i>
            ...
            <tr>
                ...
                <td><font color="red"> </font>
                    手机号码
                    <#if i==3>
                        <input id="mobilePhone${i}" name=contacterList[${i}].mobilePhone maxlength="11"   class="easyui-validatebox"  />
                         
                    <#else>
                        <font color="red">*</font>
                       <input id="mobilePhone${i}" name=contacterList[${i}].mobilePhone maxlength="11"  required="true"   class="easyui-validatebox"  />
                    </#if>
