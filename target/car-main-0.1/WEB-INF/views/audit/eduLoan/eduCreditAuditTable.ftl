...
<script type="text/javascript" src="resources/js/audit/eduCreditAuditTable.js"></script>
<style type="text/css">
...
<form id="auditListForm" method="post" enctype="multipart/form-dat">
	...
	<table id="base" align="center" class="m2 ">
		...
		<tr>
			...
			<td><input id="ratioOfInvestments" name="ratioOfInvestments" class="easyui-numberbox " validType="integerCheck" maxlength="3"></input>%</td>
		...
		<tr>
			<td align='center' colspan='8'><a href="javascript:void(0)" id="auditSubmitBt"
				class="easyui-linkbutton"  onclick="AuditSubmitBt()">提交</a> <a
				href="javascript:void(0)" style="margin-right: 10px"
				id="auditCancelBt" class="easyui-linkbutton  commonCloseBut" >取消</a>
			</td>
		</tr>
	</table>
</form>
