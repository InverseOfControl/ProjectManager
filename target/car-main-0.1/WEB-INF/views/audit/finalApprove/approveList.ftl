...
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/finalApprove/approveList.js"></script>
<script type="text/javascript" src="resources/js/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" charset="UTF-8" src="resources/js/apply/seLoan/seLoanApply.js"></script> 
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/finalApprove/changeToFirst.js"></script>
...
<body>
	...
	<!-- 变更初审员 -->
	<div id="changeToFirstDlg" class="easyui-dialog" style="width: 500px;height: 130px;" closed="true" data-options="resizable:true">
		<form id="changeToFirstForm" method="post" enctype="multipart/form-dat">
			<div id="changeToFirstTab" title="合同日志" style="padding:20px">
		 	  <table style="font-size:12px; width:100%; text-align:left;height: 100%">
		 	   		<tr>
						<td><div>
						分派给：</div><input type="hidden" name="id" id="loanIdChange" /></td>
						<td><div>
						<input id="firstTrialId3" name="firstTrialId" class="easyui-combobox" 
						/>
						</div>
						</td>
					</tr>
					<tr>
						<td><a href="javascript:void(0)"
							class="easyui-linkbutton"  onclick="auditSubmitBt()">提交</a></td> 
						<td><a	href="javascript:void(0)" style="margin-right: 10px"
							class="easyui-linkbutton  " onclick="javascript:$('#changeToFirstDlg').dialog('close')" >取消</a>
						</td>
					</tr>
				</table>
			</div>
