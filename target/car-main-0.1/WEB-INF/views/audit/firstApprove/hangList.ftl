...
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/fristApprove/hangList.js"></script>
	 ...
	 <div id="hangUpPanel" class="easyui-window" title="挂起" style="width:600px;"   data-options="collapsible:false,minimizable:false,maximizable:false, resizable:false">
        ...
        <span>
         ...
         <div style="text-align:center;padding:5px">
            <a href="javascript:void(0)" class="easyui-linkbutton editBtn" onclick="doHangUpLoan()">确定</a>
