...
<body>
    ...
    <div id="productTableDiv" style=" closed="true" data-options="resizable:true">
	    ...
	    <tr style="height:40px" >
	      ...
	      <tr style="height:40px" >
	       ...
	       <tr style="height:40px" >
	        ...
	        <td> 
        					<#if (type1)?? && type1?size gt 0>  <button type="button"   onclick="ClickMe(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe(0)" >添 加</button>
        					 </#if> 
	     		 ...
	     		 <table  id="mytable" border="1"  bordercolor="#a0c6e5" style="border-collapse:collapse" >
	     		 	...
	     		 	<#list type1 as pv>  
  						<tr  style="height:200px;text-align:center"> 
  							...
  							<td><input type='button' id='edit'  value='编辑 ' onclick='editRow(this)' /><input type='button' value='删除' onclick='delRow(this)' /></td>
  						</tr>
	    ...
	    <tr style="height:40px" >
	        ...
	        <td> 
        					<#if (type2)?? && type2?size gt 0>  <button type="button"   onclick="ClickMe2(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe2(0)" >添 加</button>
        					 </#if> 
	    ...
	    <tr>
	      ...
	      <tr  >
	        ...
	        <td> 
        				<#if (type3)?? && type3?size gt 0>  <button type="button"   onclick="ClickMe3(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe3(0)" >添 加</button>
        			    </#if> 
	        </td>
	    </tr>
	     <tr>
	     ...
	     <tr   >
	        ...
	        <td> 
        					<#if (type4)?? && type4?size gt 0>  <button type="button"   onclick="ClickMe4(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe4(0)" >添 加</button>
        					 </#if> 
	        </td>
	    </tr>
	         <tr>
	        ...
	        <td> 
        					<#if (type5)?? && type5?size gt 0>  <button type="button"   onclick="ClickMe5(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe5(0)" >添 加</button>
        					 </#if> 
	        </td>
	    </tr>
	         <tr>
	     ...
	     <#if (pv5)??>    
	      <tr   >
	        ...
	        <td> 
        					<#if (type6)?? && type6?size gt 0>  <button type="button"   onclick="ClickMe6(1)" >添 加</button>
        							<#else> <button type="button"   onclick="ClickMe6(0)" >添 加</button>
        					 </#if> 
	        </td>
	    </tr>
