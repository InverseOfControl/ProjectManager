...
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/approvePhone/approvePhoneMain.js"></script>
		...
		<div class="easyui-layout" data-options="fit:true">
          ...
          <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">			
			...
			<div id="centerTabs" class="easyui-tabs" data-options="region:'center',border:false,tools:'#tab-tools'">
				<div title="审核列表">	<iframe id="iframe1" src="approvePhone/approvePhoneData/toApproveTab" frameborder="0" style="border:0;width:100%;height:100%;"></iframe></div>
			</div>
		</div>
	</div>
