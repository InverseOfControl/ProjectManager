...
<script type="text/javascript" charset="UTF-8" src="resources/js/audit/repaymentMsgLog/repaymentMsgLog.js"></script>
...
<body>
	<table id="repaymentMsgLog_result" toolbar="#toolbar"></table>
	<!-- toolbar  -->
