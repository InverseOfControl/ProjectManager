...
<script type="text/javascript" charset="UTF-8" src="resources/js/system/productAdd.js"></script>
    ...
    <div id="seTermsTableDiv" style="display:none">
	    ...
	    <tr>
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate3"   name="sumRate3" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	            &nbsp;<label style="font-weight:bold">%</label> 
	        </td>
	        <td>
	        &nbsp;
	    ...
	    <tr>
	       ...
	       &nbsp;
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate6" name="sumRate6" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	             &nbsp;<label style="font-weight:bold">%</label>
	        </td>
	        <td>
	        &nbsp;
	    ...
	    <tr>
	      ...
	      &nbsp;
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate9" name="sumRate9" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	            &nbsp;<label style="font-weight:bold">%</label>
	        </td>
	        <td>
	        &nbsp;
	    ...
	    <tr>
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate12" name="sumRate12" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	            &nbsp;<label style="font-weight:bold">%</label>
	        </td>
	        <td>
	        &nbsp;
	    ...
	    <tr>
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate18" name="sumRate18" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	            &nbsp;<label style="font-weight:bold">%</label>
	        </td>
	        <td>
	        &nbsp;
	    ...
	    <tr>
	        ...
	        &nbsp;
	        	<label>综合费率</label> 
	            <input id="sumRate24" name="sumRate24" validType="moneyCheck" class="easyui-validatebox" maxlength="10"   style="width: 90px"/>
	            &nbsp;<label style="font-weight:bold">%</label>
	        </td>
	        <td>
	        &nbsp;
