 ...
 <link rel="stylesheet" type="text/css" href="resources/css/apply/loan.css" />
    ...
    <tr>
        ...
        <td>
        	<span class="pre_span"><font color="red">*</font></span>
        	<label> 性　　别</label> 
            <select id="carPersonSex" name="carPersonSex" class="easyui-combobox"  editable="false"  style="maxwidth:60px">
    ...
    <tr>
        ...
        <td>
        	<span class="pre_span">
        	<label>  子女在读学校 </label> 
        	<input id="childrenSchool" name="childrenSchool" maxlength="50" disabled="disbaled" class="easyui-validatebox"   />
        </td>      
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
        	<span class="pre_span"></span>
        	<label>居住类型</label>
            <select name="liveType" id="liveType" class="easyui-validatebox">
        ...
        <td>
            ...
            <input id="carRentPerMonth" style="width:100px" name="carRentPerMonth"   validType="integerCheck"  maxlength="6"  class="easyui-validatebox"/>
            <span>元</span>
        </td>
         <td colspan="3">
        	<span class="pre_span"><font color="red">*</font></span>
    ...
    <tr>
    	 ...
    	 <td>
            ...
            <input id="maxRepayAmount" style="width:100px" name="maxRepayAmount"   validType="integerCheck"  maxlength="8"     class="easyui-validatebox"/>
			<span>元/月</span>
         </td>
    ...
    <!--<tr>
        ...
        <td>
        	<span class="pre_span"><font color="red">*</font></span>
        	<label>月基本薪金</label>
        	<input id="carIncomePerMonth" name="carIncomePerMonth" class="easyui-validatebox" maxlength="15"  validType="integerCheck"  required="true" style="width:90px;"/><span>元</span>
        </td>
        <td>
        	<span class="pre_span"><font color="red">*</font></span>
        	<label>  月发薪日</label>
        	<input id="payDate" name="payDate" class="easyui-numberbox" maxlength="2" max="31"  validType="integerCheck" required="true" style="width:90px;"/>
        </td>
        <td>
        	<span class="pre_span"></span>
        	<label>  其他收入</label>
        	<input id="otherIncome" style="width:90px" name="otherIncome"   maxlength="15" class="easyui-validatebox"  validType="integerCheck"  /><span>元</span>
        </td>
    </tr>-->
    <!--<tr>
        <td>
    ...
    <tr>
        ...
        <td >
        	<span class="pre_span"></span>
        	<label>  总张数&nbsp;&nbsp;</label>
            <input id="cardNum" style="" name="cardNum" class="easyui-validatebox" maxlength="2"   validType="integerCheck" disabled="disbaled"/><span> 张</span>
        </td>
        <td>
        	<span class="pre_span"></span>
        	<label>  总额度&nbsp;&nbsp;</label>
            <input id="totalAmount" name="totalAmount" class="easyui-validatebox" maxlength="15"  validType="integerCheck"  disabled="disbaled"/><span> 元</span>
        </td>
        <td>
        	<span class="pre_span"></span>
        	<label>  已透支&nbsp;&nbsp;</label>
            <input id="overdrawAmount" name="overdrawAmount" class="easyui-validatebox" maxlength="15"    validType="integerCheck"  disabled="disbaled"/><span> 元</span>
        </td>
    </tr>
    <tr>
    	<td>
    ...
    <tr>
        ...
        <td colspan="2">
        	<span class="pre_span"><font color="red">*</font></span>
        	<label> 申请日期</label>
        	<input id="carRequestDate" name="carRequestDate" readonly="true" value='${carRequestDate}'  class="easyui-validatebox"/>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <table cellpadding="5" cellspacing="5" id="addCarTableNew2" class="addCarTable" style="display: none;height: 360px;">
    <#list 0..3 as i>
        <tr>
            <td>
                联系人${i+1}
    ...
    <div id="addCarlg-buttons" style="text-align:right;padding-right:100px"  > 
        <a class="easyui-linkbutton" iconCls="icon-ok" plain="true" id="prevCarStepBtnNew" style="display: none;">上一步</a>
        <a class="easyui-linkbutton" iconCls="icon-ok" plain="true" id="nextCarStepBtnNew">下一步</a>
        <a class="easyui-linkbutton" iconCls="icon-ok" plain="true" id="addCarLoanBtnNew"   style="display: none;">保存</a>
