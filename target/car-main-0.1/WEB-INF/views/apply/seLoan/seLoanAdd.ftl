...
<script type="text/javascript" charset="UTF-8" src="resources/js/apply/apply.js"></script>
 ...
 <form id="addSeLoanForm" method="post" style="padding: 5px;">
            <table cellpadding="5" id="addTableNew1" class="chedai" cellspacing="10" style="text-align:left">
                <tr>
                    <td >
                 ...
                 <tr>
					<td>
                    	 ...
                    	 <label>申请金额</label>
					     <input id="requestMoney" class="easyui-numberbox" name="requestMoney" min="100000" max="500000" validType="requestMoneyCheck"  maxlength="6" required="true"  style="width: 90px" />
					     <span>元</span>
					</td>
                    <td>
                    	<span class="pre_span"><font color="red">*</font></span>
                ...
                <tr>
                    <td style="margin-left:0px" colspan="2">
						<span class="pre_span"><font color="red">*</font></span>
                ...
                <tr>
                    <td style="width:310px">
						<span class="pre_span"><font color="red">*</font></span>
                    	<label  style="text-indent:0"> 近年营业额</label>
                        
                        <input  id="incomePerMonth" name="incomePerMonth" required="true"  validType="integerCheck" class="easyui-validatebox" />
                        <span>万元/月</span>
                    </td>
                    <td>
                    	<span class="pre_span"><font color="red">*</font></span>
                ...
                <tr>
                    <td>
                        ...
                        <input  id="avgProfitPerYear" name="avgProfitPerYear"  maxlength="15" required="true"  class="easyui-validatebox"  /><span>万元/年</span>
                    </td>
                    <td>
                   		 <span class="pre_span"><font color="red">*</font></span>   
                    	<label> 企业电话</label>
                ...
                <#list 0..3 as i>
                    <tr>
                        ...
                        <td><font color="red">*</font>
                            姓　　名
                            <input id="contacterName${i}"  name=contacterList[${i}].name  maxlength="15" class="easyui-validatebox" required="true" />
                        </td>
                        <td><font color="red">*</font>
                            关　　系
                    ...
                    <tr class="bottomLineTr">
            			<td>
                            固定电话
                            <input id="homePhone${i}" name=contacterList[${i}].homePhone  maxlength="20" validType="telCheck"  class="easyui-validatebox" validType="telCheck" />
                        </td>
                        <td><font color="red">*</font>
                            工作单位
                            <input id="workUnit${i}" name=contacterList[${i}].workUnit maxlength="150"   class="easyui-validatebox" />
                        </td>
                        <td colspan="1"><font color="red">*</font>
                            知晓贷款
...
<script>
            $(function(){
                ...
                $('#submitEditBtnNew').bind('click',submitAdd);
