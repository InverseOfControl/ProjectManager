...
<script type="text/javascript" charset="UTF-8" src="resources/js/apply/refusalEntry/carLoanApply/carLoanApply.js"></script>
 <link rel="stylesheet" type="text/css" href="resources/css/apply/loan.css" />
    ...
    <tr>
        ...
        <td  colspan="2" >
           ...
           <td colspan="2">
        	<span class="pre_span"><font color="red">*</font></span>
        	<label> 拒单日期</label>
        	<input id="carRequestDate"  name="carRequestDate" style="width: 180px"  editable="false"    class="easyui-datebox"/>           
        </td>
    </tr>  
    <tr>
        <td>
        ...
        <td colspan="2">
            ...
            <input id="bizNameEdit" name="bizName" class="easyui-combobox"  style="width:140px" />
        </td>
    ...
    <div id="addCarlg-buttons" style="text-align:center;padding-right:100px"  > 
        <a class="easyui-linkbutton" iconCls="icon-ok" plain="true" id="updateCarLoanBtnNew"      >保存</a>
...
<script>
            $(function(){
                ...
                $('#updateCarLoanBtnNew').bind('click',editCarLoan);
                $('#cancelCarLoanBtn').bind('click',cancelCarLoanModify);  
            })
</script>		
</body>
</html>