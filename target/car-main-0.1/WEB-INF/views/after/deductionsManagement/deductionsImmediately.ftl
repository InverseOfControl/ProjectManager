...
<script type="text/javascript" charset="UTF-8" src="resources/js/after/deductionsManagement/deductionsImmediately.js"></script>
...
<body>
	...
	<div id="toolbar" style="height:auto;padding-top:8px;">
        ...
        <div style="margin: 7px 0 0px 0px;padding:5px;padding-left:5px;border:solid 1px #99CCFF;background:#ededed;border-top-left-radius:5px;">
			...
			<a href="javascript:void(0)" id="generateBt" class="easyui-linkbutton" data-options="iconCls:'icon-search'">生成实时划扣记录</a> 
		</div>	
	</div>
