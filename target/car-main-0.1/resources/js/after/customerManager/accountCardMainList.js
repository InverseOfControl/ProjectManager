...
$(function () {
    ...
    $('#list_result').datagrid({
        url: 'after/customerManager/accountCardMainList?loanId='+ $('#loanId').val()+'&extensionTime='+ $('#extensionTime').val(),
        fitColumns : true,
        border : false,
        striped: true,
        fit:true,
...
function accountCardDetails(tradeNo,id,payType){
 $('#accountCardDetailsDlg').dialog({
	...
	var url = 'after/customerManager/accountCardFlow?loanId='+id+'&tradeNo='+tradeNo+'&payType='+payType;
