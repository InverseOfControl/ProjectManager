...
function openWindows(id){
	 window.open(appname+"audit/eduLoanList/eduCreditAuditList/"+id,"newwindow2","toolbar=yes,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,fullscreen=3");

}

function openWindowsL(id){
	 window.open(appname+"audit/eduLoanList/eduCreditAuditListLApprove/"+id,"newwindow3","toolbar=yes,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,fullscreen=3");
